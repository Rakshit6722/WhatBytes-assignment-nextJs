    ...
    afterDatasetsDraw: (chart) => {
      ...
      if (tooltip?.getActiveElements()?.length) {
        ...
        meta.data.forEach((point, index) => {
          ...
          const baseRadius = 3;
          const hoverRadius = 7;
          con        const activePoint = tooltip.getActiveElements()[0];
        const meta = chart.getDatasetMeta(0);
...
export default DynamicPercentileGraph;st radius = isActive ? hoverRadius : baseRadius;
